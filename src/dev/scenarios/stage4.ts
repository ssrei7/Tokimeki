    ...
    create: (): SaveFile => {
      ...
      return {
        ...
        world: {
          ...
          npcTemplates: {}, encounterLog: [], topicTrees: {}, usedTopics: {}, appointments: [], eventDefs: {}, director: { scheduled: [], lastFiredDay: {}, tension: 0 }, eventHistory: [], chapters: [], milestones: [], giftHistory: [], collection: [
