    ...
    create: (): SaveFile => {
      ...
      return {
        ...
        world: {
          ...
          player: {
            name: '测试玩家', nodeId: 'start', stats: { money: 0, 'economy.rent.amount': 10, 'economy.rent.interval-days': 7, 'economy.job.wage': 18, energy: 6, 'economy.energy.max': 6, 'economy.energy.rest-restore': 2 }, flags: { 'economy.energy.enabled': true },
            inventory: [
