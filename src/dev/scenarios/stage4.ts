import { CURRENT_SCHEMA_VERSION, DEFAULT_ACTION_COSTS, DEFAULT_DIRECTOR_STATE, DEFAULT_ECONOMY_STATE, DEFAULT_SLOT_DEFS, DEFAULT_TERMINAL_STATE, createDefaultMap, type SaveFile } from '../../data/schema/save';
    ...
    create: (): SaveFile => {
      ...
      return {
        ...
        world: {
          ...
          }, relations: {}, diary: [], settlements: [], morningBriefs: [], hooks: [], morningUpdates: [], map,
          characters: {
          ...
          npcTemplates: {}, encounterLog: [], topicTrees: {}, usedTopics: {}, appointments: [], eventDefs: {}, director: structuredClone(DEFAULT_DIRECTOR_STATE), eventHistory: [], chapters: [], milestones: [], storyScenes: [], economy: structuredClone(DEFAULT_ECONOMY_STATE), placeHighlights: [], giftHistory: [], collection: [
