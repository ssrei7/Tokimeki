...
function ProviderSettingsMigrationView(props: { providers: ProviderConfig[]; ttsConfigs: TtsConfig[]; onExport: (selection: ProviderSettingsSelection) => Promise<void>; onImport: (pack: ProviderSettingsPackage, selection: ProviderSettingsSelection) => Promise<void> }) {
...
function SettingsView(props: {
  ...
  if (props.activePage === 'migration') return <SubpageShell title={pageTitle} pageId="migration" onBack={props.onBack}><ProviderSettingsMigrationView providers={props.providers} ttsConfigs={props.ttsConfigs} onExport={props.onExportProviderSettings} onImport={props.onImportProviderSettings} /></SubpageShell>;
