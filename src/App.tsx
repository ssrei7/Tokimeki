...
import { createEconomyOpRegistry, formatCurrency, getJobQuote, getJobShiftStatus, getRentalQuote, getShopOffer, getShopStatus, injectEconomyMorningAds, registerEconomyHooks } from './features/economy';
...
const defaultSave: SaveFile = SaveFileSchema.parse({
  ...
  world: {
    ...
    slotsUsedToday: 0,
    player: { name: '旅人', nodeId: 'start', stats: { 'custom-reputation': 0, money: 0, 'economy.rent.amount': 10, 'economy.rent.interval-days': 7, 'economy.job.wage': 18, 'economy.shop.days-open': 0, energy: 6, 'economy.energy.max': 6, 'economy.energy.rest-restore': 2 }, flags: { 'economy.energy.enabled': true }, inventory: [] },
    stats: {}, flags: {},
