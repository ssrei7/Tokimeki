...
import { buildPromoteNpcOp, characterCardFromPromotedCharacter, createNpcPromotionDraft, summarizeNpcSchedule, type NpcPromotionDraft } from './ui/npc-promotion';
...
function ContactsView(props: { save: SaveFile; onRequestFriend: (characterId: string, direction: ContactDirection) => void; onResolveFriend: (requestId: string, action: 'accept' | 'reject' | 'revoke') => void; onOpenMessage: (characterId: string) => void; onPromoteNpc: (characterId: string, draft: NpcPromotionDraft) => Promise<boolean> }) {
