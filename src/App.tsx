...
import { advanceStorySceneStage, confirmStoryScene, createBuiltinStoryScenePresets, createStorySceneDraft, deleteStorySceneDraft, formatChatArchive, formatEventHistoryArchive, generateStorySceneDraftInput, readStorySceneStage, selectStorySceneReadingStage, updateStorySceneDraft, type StorySceneDraftInput } from './core/story';
...
export function App() {
  ...
  return <div className="app-shell">
    ...
    <main className={`screen ${tab === 'chat' ? 'chat-screen-host' : ''} ${tab === 'map' ? 'map-screen-host' : ''}`}>
      ...
      {tab === 'library' && <StorySceneLibraryView save={save} onCreateDraft={createStorySceneDraftFromInput} onEditDraft={editStorySceneDraft} onDeleteDraft={removeStorySceneDraft} onConfirmDraft={confirmStorySceneDraft} onAdvanceStage={advanceStoryScene} onReadStage={(sceneId, stageId) => updateStorySceneReading(sceneId, stageId, 'read')} onSelectStage={(sceneId, stageId) => updateStorySceneReading(sceneId, stageId, 'select')} />}
...
function StorySceneLibraryView(props: { save: SaveFile; onCreateDraft: (input: StorySceneDraftInput) => void; onEditDraft: (sceneId: string, input: StorySceneDraftInput) => void; onDeleteDraft: (sceneId: string) => void; onConfirmDraft: (sceneId: string) => void; onAdvanceStage: (sceneId: string) => void; onReadStage: (sceneId: string, stageId: string) => void; onSelectStage: (sceneId: string, stageId: string) => void }) {
