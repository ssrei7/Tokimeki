...
import { Backpack, BookOpen, Bot, BrainCircuit, Bug, ContactRound, FileArchive, MessageCircle, Music2, Palette, Phone, Route, ShieldCheck, SlidersHorizontal, UserRound, UsersRound, Wrench } from 'lucide-react';
