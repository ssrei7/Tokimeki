...
export const TASK_IDS = [
  ...
  'map_gen', 'map_activity_gen', 'npc_batch', 'extract_ops', 'summarize_memory', 'summarize_day', 'summarize_chapter', 'workshop_draft', 'image', 'tts',
] as const;
...
export const ImageConfigSchema = z.object({
  ...
  multiReferenceEnabled: z.boolean().default(false),
  editEndpoint: z.string().optional(),
  lastGenerated: z.object({
    asset: z.object({ kind: z.literal('stored'), assetId: z.string().min(1) }),
