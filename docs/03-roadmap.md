...
**schema**：阶段 7 首个事件切片从当前实际 v22 升至 v23，加入 `world.eventDefs` / `world.director.scheduled` / `world.eventHistory`；事件回顾元数据切片再升至 v24，静态事件结果选项切片升至 v25，证物反应规则切片升至 v26，章节、里程碑等后续切片继续在此基础上递增版本。
